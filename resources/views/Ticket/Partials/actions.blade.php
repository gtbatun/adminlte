<div class="d-flex justify-content-center  align-items-center">
    ...
    <button type="button" class="btn btn-warning modal-reasig-btn" data-toggle="modalreasig" data-target="#modal-reasig-ticket" data-ticket-id="{{ $ticket->id }}" data-ticket-title="{{ $ticket->title }}">Reasignar</button>
    @can('admin-access')
