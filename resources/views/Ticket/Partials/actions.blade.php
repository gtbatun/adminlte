<div class="d-flex justify-content-center  align-items-center">
    ...
    <button type="button" class="btn btn-secondary modal-gestion-btn mr-2" data-toggle="modalgestion" data-target="#modal-gestion-ticket" 
    data-ticket-id="{{ $ticket->id }}" data-ticket-title="{{ $ticket->title }}" data-ticket-description="{{ $ticket->description }}" data-ticket-department="{{ $ticket->department_id }}">Gestion</button>
